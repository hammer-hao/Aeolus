...
namespace Aeolus
{
	...
	void ConsolidateState::macro(AeolusBot& aeolusbot)
	{
        ...
        aeolusbot.RegisterBehavior(std::make_unique<BuildDetection>(true)); // force detection
    ...
    void ConsolidateState::_oracleHarassMicro(AeolusBot& aeolusbot, ::sc2::Units oracles, std::vector<::sc2::Point2D> harassLocations)
    {
