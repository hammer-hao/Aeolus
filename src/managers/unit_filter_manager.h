...
namespace Aeolus
{
	...
	private:
		...
		::sc2::Units m_enemy_cloaked_or_burrowed_units;

		// Set to keep track of the known enemy units that are still alive
		std::unordered_map<::sc2::Tag, const ::sc2::Unit*> m_knownEnemyUnits;
