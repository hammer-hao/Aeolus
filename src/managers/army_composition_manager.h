	...
	*/
	...
	public:
        ...
        inline static const std::unordered_map<::sc2::UNIT_TYPEID, CompositionWeights> ARMY_COMPOSITION_LOOKUP = {
            ...
            {::sc2::UNIT_TYPEID::ZERG_ZERGLING, {0.70f, 0.00f, 0.00f, 0.30f, 0.00f}},
            {::sc2::UNIT_TYPEID::ZERG_BANELING, {0.80f, 0.00f, 0.00f, 0.20f, 0.00f}},
            ...
            {::sc2::UNIT_TYPEID::TERRAN_MARINE, {0.60f, 0.00f, 0.00f, 0.40f, 0.00f}},
            {::sc2::UNIT_TYPEID::TERRAN_MARAUDER, {0.20f, 0.30f, 0.30f, 0.20f, 0.00f}},
            ...
            {::sc2::UNIT_TYPEID::TERRAN_CYCLONE, {0.60f, 0.40f, 0.00f, 0.00f, 0.00f}},
            ...
            {::sc2::UNIT_TYPEID::PROTOSS_ZEALOT, {0.70f, 0.00f, 0.00f, 0.30f, 0.00f}},
            {::sc2::UNIT_TYPEID::PROTOSS_ADEPT, {0.70f, 0.00f, 0.00f, 0.30f, 0.00f}},
