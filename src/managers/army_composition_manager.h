	...
	*/
	...
	public:
        ...
        inline static const std::unordered_map<::sc2::UNIT_TYPEID, CompositionWeights> ARMY_COMPOSITION_LOOKUP = {
            ...
            {::sc2::UNIT_TYPEID::ZERG_ULTRALISK, {0.30f, 0.70f, 0.00f, 0.00f, 0.00f}},
            ...
            {::sc2::UNIT_TYPEID::ZERG_QUEEN, {0.60f, 0.40f, 0.00f, 0.00f, 0.00f}},

            {::sc2::UNIT_TYPEID::TERRAN_MARINE, {1.00f, 0.00f, 0.00f, 0.00f, 0.00f}},
            {::sc2::UNIT_TYPEID::TERRAN_MARAUDER, {0.50f, 0.00f, 0.50f, 0.00f, 0.00f}},
            {::sc2::UNIT_TYPEID::TERRAN_REAPER, {1.00f, 0.00f, 0.00f, 0.00f, 0.00f}},
            {::sc2::UNIT_TYPEID::TERRAN_GHOST, {0.70f, 0.30f, 0.00f, 0.00f, 0.00f}},
            {::sc2::UNIT_TYPEID::TERRAN_HELLION, {1.00f, 0.00f, 0.00f, 0.00f, 0.00f}},
            {::sc2::UNIT_TYPEID::TERRAN_HELLIONTANK, {1.00f, 0.00f, 0.00f, 0.00f, 0.00f}},
            {::sc2::UNIT_TYPEID::TERRAN_WIDOWMINE, {1.00f, 0.00f, 0.00f, 0.00f, 0.00f}},
            ...
            {::sc2::UNIT_TYPEID::PROTOSS_ZEALOT, {1.00f, 0.00f, 0.00f, 0.00f, 0.00f}},
            {::sc2::UNIT_TYPEID::PROTOSS_ADEPT, {1.00f, 0.00f, 0.00f, 0.00f, 0.00f}},
            ...
            {::sc2::UNIT_TYPEID::PROTOSS_VOIDRAY, {1.00f, 0.00f, 0.00f, 0.00f, 0.00f}},
            {::sc2::UNIT_TYPEID::PROTOSS_CARRIER, {0.00f, 0.00f, 1.00f, 0.00f, 0.00f}},
            {::sc2::UNIT_TYPEID::PROTOSS_TEMPEST, {0.00f, 0.00f, 1.00f, 0.00f, 0.00f}},
