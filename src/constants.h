...
namespace Aeolus {
	namespace constants
	{
		...
		enum class ManagerRequestType
		{
			...
			FIND_FURTHEST_GROUND_SAFE_SPOT_TOWARDS,
			FIND_FURTHEST_AIR_SAFE_SPOT_TOWARDS,
			FIND_CLOSEST_SAFE_SPOT_TOWARDS,
			...
			IS_BUILDING_AREA_CLEAR,
			REQUEST_ALTERNATE_BUILDING_PLACEMENT,
			CLEAR_WORKER_ON_ROUTE,
			IS_NATURAL_WALL_COMPLETE,
			IS_POINT_OCCUPIED,
		...
		const std::set<::sc2::UnitTypeID> DESTRUCTABLE2X2_IDS =
		{
			...
			::sc2::UNIT_TYPEID::NEUTRAL_UNBUILDABLEPLATESDESTRUCTIBLE,
			::sc2::UNIT_TYPEID::NEUTRAL_UNBUILDABLEBRICKSDESTRUCTIBLE,
			::sc2::UNIT_TYPEID::UNBUILDABLEROCKSDESTRUCTIBLE,
		...
		const std::unordered_map<::sc2::UPGRADE_ID, std::vector<::sc2::UNIT_TYPEID>> UPGRADE_TECH_REQUIREMENT = {
			...
			{::sc2::UPGRADE_ID::PROTOSSAIRWEAPONSLEVEL1, {
				::sc2::UNIT_TYPEID::PROTOSS_CYBERNETICSCORE,
			} },
			{::sc2::UPGRADE_ID::PROTOSSAIRWEAPONSLEVEL2, {
				::sc2::UNIT_TYPEID::PROTOSS_CYBERNETICSCORE,
				::sc2::UNIT_TYPEID::PROTOSS_STARGATE,
				::sc2::UNIT_TYPEID::PROTOSS_FLEETBEACON
			} },
			{::sc2::UPGRADE_ID::PROTOSSAIRWEAPONSLEVEL3, {
				::sc2::UNIT_TYPEID::PROTOSS_CYBERNETICSCORE,
				::sc2::UNIT_TYPEID::PROTOSS_STARGATE,
				::sc2::UNIT_TYPEID::PROTOSS_FLEETBEACON
			} },
			...
			{::sc2::UPGRADE_ID::EXTENDEDTHERMALLANCE, {
				::sc2::UNIT_TYPEID::PROTOSS_CYBERNETICSCORE,
				::sc2::UNIT_TYPEID::PROTOSS_ROBOTICSFACILITY,
				::sc2::UNIT_TYPEID::PROTOSS_ROBOTICSBAY
			} },
		...
		const std::unordered_map<::sc2::UNIT_TYPEID, std::vector<::sc2::UNIT_TYPEID>> UNIT_TECH_REQUIREMENT = {
			// Protoss Units
			{::sc2::UNIT_TYPEID::PROTOSS_ADEPT, { ::sc2::UNIT_TYPEID::PROTOSS_GATEWAY, ::sc2::UNIT_TYPEID::PROTOSS_CYBERNETICSCORE }},
			{ ::sc2::UNIT_TYPEID::PROTOSS_ARCHON, {} },
			{ ::sc2::UNIT_TYPEID::PROTOSS_CARRIER, {::sc2::UNIT_TYPEID::PROTOSS_STARGATE, ::sc2::UNIT_TYPEID::PROTOSS_FLEETBEACON} },
			{ ::sc2::UNIT_TYPEID::PROTOSS_COLOSSUS, {
				::sc2::UNIT_TYPEID::PROTOSS_GATEWAY,
				::sc2::UNIT_TYPEID::PROTOSS_CYBERNETICSCORE,
				::sc2::UNIT_TYPEID::PROTOSS_ROBOTICSFACILITY,
			...
			{ ::sc2::UNIT_TYPEID::PROTOSS_PROBE, {::sc2::UNIT_TYPEID::PROTOSS_NEXUS} },
			{ ::sc2::UNIT_TYPEID::PROTOSS_SENTRY, {
				::sc2::UNIT_TYPEID::PROTOSS_GATEWAY,
				::sc2::UNIT_TYPEID::PROTOSS_CYBERNETICSCORE
			} },
			...
			{ ::sc2::UNIT_TYPEID::PROTOSS_ZEALOT, {::sc2::UNIT_TYPEID::PROTOSS_GATEWAY} },

				// Protoss Structures
			{ ::sc2::UNIT_TYPEID::PROTOSS_NEXUS, { ::sc2::UNIT_TYPEID::PROTOSS_NEXUS } },
			{ ::sc2::UNIT_TYPEID::PROTOSS_PYLON, { ::sc2::UNIT_TYPEID::PROTOSS_PYLON } },
			{ ::sc2::UNIT_TYPEID::PROTOSS_ASSIMILATOR, { ::sc2::UNIT_TYPEID::PROTOSS_ASSIMILATOR } },
			{ ::sc2::UNIT_TYPEID::PROTOSS_ASSIMILATORRICH, { ::sc2::UNIT_TYPEID::PROTOSS_ASSIMILATORRICH } },
			{ ::sc2::UNIT_TYPEID::PROTOSS_GATEWAY, {
				::sc2::UNIT_TYPEID::PROTOSS_PYLON,
				::sc2::UNIT_TYPEID::PROTOSS_NEXUS,
				::sc2::UNIT_TYPEID::PROTOSS_GATEWAY
